...
import com.kashif.feature_search.presentation.PagingState
import com.kashif.feature_search.presentation.SearchScreen
import com.kashif.feature_search.presentation.UIEvent
...
class SearchScreenKtTest {
    ...
    @Test
    fun movieNodeExists(){
        rule.onNodeWithTag("Day Hunter",).assertExists("Movies not showing")
    }
